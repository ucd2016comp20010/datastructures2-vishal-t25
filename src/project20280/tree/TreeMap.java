    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public void rotate(Position<Entry<K, V>> p) {
            ...
            if (z == null) {
                ...
                relink(z, x, y == z.getLeft()); // link x to z
            }
            // now rotate x and y
            if (x == y.getLeft()) {
                relink(y, x.getRight(), true); // link right child of x to left of y
                relink(x, y, false); // link y to right of x
            } else {
                relink(y, x.getLeft(), false); // link left child of x to right of y
                relink(x, y, true); // link y to left of x
            }
